...
public class ClientLineItemServiceimpl implements ClientLineItemService {
	...
	@SuppressWarnings("unchecked")
	@Override
	public ArrayList<ClientLineItemEntity> uploadClientLineItemExcelSheet(CompletedFileUpload file) throws ClientLineItemServiceException {
		try {
			String dataBaseName = ClientLineItemServiceimpl.dataBaseName();
		ArrayList<ClientLineItemEntity> list=	this.clientLineItemDao.uploadClientLineItem(file, dataBaseName);
			return list;
		} catch (Exception e) {
			// TODO: handle exception
			throw new ClientLineItemServiceException(e.getMessage());
