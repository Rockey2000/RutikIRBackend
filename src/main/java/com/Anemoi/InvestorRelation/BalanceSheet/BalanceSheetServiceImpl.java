...
public class BalanceSheetServiceImpl implements BalanceSheetService {
	...
	public ArrayList<BalanceSheetEntity> addObjectBalanceSheetEntity(ArrayList<BalanceSheetEntity> balanceSheetEntity)
		...
		try {
			String dataBaseName = BalanceSheetServiceImpl.dataBaseName();
			ArrayList<BalanceSheetEntity> entity = this.balancesheetdao.addObjectBalanceSheetEntity(balanceSheetEntity,
					dataBaseName);
			return entity;
		} catch (Exception e) {
			// TODO: handle exception
	...
	@SuppressWarnings("unchecked")
	@Override
	public ArrayList<BalanceSheetEntity> uploadBalanceSheetExcel(CompletedFileUpload file) throws BalanceSheetServiceException {
		// TODO Auto-generated method stub
...
//			validate(file);		will work on it		
		...
		ArrayList<BalanceSheetEntity> presentlist=	this.balancesheetdao.uploadBalanceSheetExcel(file, dataBaseName);
