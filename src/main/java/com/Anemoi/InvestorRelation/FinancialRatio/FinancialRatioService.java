...
public interface FinancialRatioService {
	...
	FinancialRatioEntity CreateFinancialRatio(FinancialRatioEntity finacialEntity) throws FinancialRatioServiceException;
	...
	FinancialRatioEntity updateFinancialRatio(FinancialRatioEntity finacialEntity, String financialid) throws FinancialRatioServiceException;
