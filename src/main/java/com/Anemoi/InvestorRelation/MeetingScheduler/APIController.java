...
public class APIController {
  ...
  public ArrayList<MSTeamschedule> getMeetingSchedueList() throws ControllerException
  {
	...
	public String deleteScheduleMeetingData(@PathVariable("meetingSheduleId") long meetingSheduleId) throws ControllerException
	{
		try
		{
		
			String response=this.si.deleteScheduleMeeting(meetingSheduleId);
			return response;
