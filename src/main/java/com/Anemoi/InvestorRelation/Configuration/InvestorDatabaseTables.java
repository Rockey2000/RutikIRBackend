...
public static final String DATA_BASE_PLACE_HOLDER="#$dataBaseName#$";
    ...
    public static final String CREATE_DATAINGESTION_MAPPING_TABLE="CREATE TABLE #$dataBaseName#$.dbo.dataIngestionMappingtable(mapId uniqueidentifier NOT NULL,fieldId bigint NOT NULL,analyst varchar(255) ,companyName varchar(255) ,documentType varchar(255) ,year varchar(255) NOT NULL,lineItemName varchar(255) NOT NULL,quarter varchar(255) NOT NULL,type varchar(255) NOT NULL,value varchar(255) ,CONSTRAINT mapId PRIMARY KEY CLUSTERED(mapId))";
