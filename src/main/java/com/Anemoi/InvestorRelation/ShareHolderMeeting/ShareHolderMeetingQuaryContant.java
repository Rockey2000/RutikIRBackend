...
public class ShareHolderMeetingQuaryContant {
	...
	public static final String UPDATE_SHAREHOLDERMEETING = "UPDATE #$DataBaseName#$.dbo.shareholdermeeting SET date=?, startTime=?, endTime=?,organisation=?,stakeholderType=?,meetingType=? ,subject=?,broker=?,location=?,status=?,comments=?,participants=?,feedback=?,uploadedDate=?,uploadedBy=? WHERE shareholderid=?";
