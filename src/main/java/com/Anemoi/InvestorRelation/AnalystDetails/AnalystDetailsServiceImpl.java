...
public class AnalystDetailsServiceImpl implements AnalystDetailsService {
	...
	public AnalystDetailsEntity createAnalystDetails(AnalystDetailsEntity analystdetails) throws AnalystDetailsServiceException {
      ...
      return entity;
		...
		// TODO: handle exception
    	  e.printStackTrace();
    	  throw new AnalystDetailsServiceException("unable to create analyst details"+e.getMessage());
	...
	public AnalystDetailsEntity getAnalystDetailsById(String analystId)  throws AnalystDetailsServiceException{
		...
		try {
			...
			// TODO: handle exception
			e.printStackTrace();
			throw new AnalystDetailsServiceException("unable to get analyst details by id"+e.getMessage());
		}
	...
	public ArrayList<AnalystDetailsEntity> getAllAnalystDetails() throws AnalystDetailsServiceException{
		...
		e.printStackTrace();
		throw new AnalystDetailsServiceException("unable to get analyst details"+e.getMessage());
	}
		...
		try {
			String dataBaseName = AnalystDetailsServiceImpl.dataBaseName();
				if (analystId == null || analystId.isEmpty()) {
					System.out.println("analyst id can't be null or empty ");
				
				}
				AnalystDetailsEntity analystEntity = this.analystDao.updateAnalystDetails(analystDetails, analystId, dataBaseName);
				JSONObject object = new JSONObject();
			...
			e.printStackTrace();
			throw new AnalystDetailsServiceException("unable to update analyst details"+e.getMessage());
		}
	...
	public AnalystDetailsEntity deleteAnalystDetails(String analystId) {
		try {
			String dataBaseName = AnalystDetailsServiceImpl.dataBaseName();
				if (analystId == null || analystId.isEmpty()) {
					System.out.println("analyst details cannot be null or empty");
