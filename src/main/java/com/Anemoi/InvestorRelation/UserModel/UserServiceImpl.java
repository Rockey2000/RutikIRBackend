...
public class UserServiceImpl implements UserService {
	...
	//	applyValidation(user);
		...
		UserEntity createNewUser=this.userdao.createNewUser(user, dataBaseName,password);
	...
	private void sendFirstTimeRegistrationEmailToUser(Transport transport, UserEntity user,String password) {
		...
		System.out.println("*************************");
		mailService.sendFirstTimeRegistrationMailToUser(transport, user.getEmail(), user.getFirstName(),user.getRoleName(),password);
	}
