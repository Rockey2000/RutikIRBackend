...
public class ShareHolderDataFromQuaryConstant {
	...
	public static final String UPDATE_SHAREHOLDERDATAFORM = "UPDATE #$DataBaseName#$.dbo.shareholderdataform SET clientName=?, portfolioid=?, folio=?,shareholdername=?,holdingvalue=?,holdingpercentage=?,holdingCost=?,minorcode=?,fundGroup=?,date=? WHERE shareid=?";
