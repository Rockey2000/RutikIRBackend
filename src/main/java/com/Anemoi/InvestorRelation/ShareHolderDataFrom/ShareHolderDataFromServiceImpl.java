...
public class ShareHolderDataFromServiceImpl implements ShareHoderDataFromService {
	...
	@SuppressWarnings("unchecked")
	@Override
	public ArrayList<ShareHolderDataFromEntity> uploadShareHolderDataExcelSheet(CompletedFileUpload file) throws ShareHolderDataFromServiceException {
		try {
			String dataBaseName = ShareHolderDataFromServiceImpl.dataBaseName();
			ArrayList<ShareHolderDataFromEntity> list=this.shareholderdataformdao.uploadShareHolderDataExcelSheet(file, dataBaseName);
		  return list;
		} catch (Exception e) {
