...
public class IncomeStatementController {
	...
	public MutableHttpResponse<?> uploadExcelSheetinIncomeTable(CompletedFileUpload file)
			throws IncomeStatementControllerException {
		try {
			System.out.println("check1");
			ArrayList<IncomeStatementEntity> response = this.service.uploadExcelSheetIncomeTable(file);
			if(response.isEmpty())
			{
