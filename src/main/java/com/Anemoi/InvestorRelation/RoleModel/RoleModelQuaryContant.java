...
public class RoleModelQuaryContant {
	...
	public static final String SELECT_ROLEMODEL_BY_ID = "select  #$DataBaseName#$.dbo.rolemodel.*,count(#$DataBaseName#$.dbo.user1.roleName) as number_of_user from #$DataBaseName#$.dbo.rolemodel left join #$DataBaseName#$.dbo.user1 on (#$DataBaseName#$.dbo.rolemodel.roleName=#$DataBaseName#$.dbo.user1.roleName) where id=?  group by #$DataBaseName#$.dbo.rolemodel.id,#$DataBaseName#$.dbo.rolemodel.roleName,  #$DataBaseName#$.dbo.rolemodel.description,#$DataBaseName#$.dbo.rolemodel.status,#$DataBaseName#$.dbo.rolemodel.dashboardAccess,#$DataBaseName#$.dbo.rolemodel.lastEdit,#$DataBaseName#$.dbo.rolemodel.createdOn";

	public static final String SELECT_ROLEMODEL_BY_ROLE = "select  #$DataBaseName#$.dbo.rolemodel.*,count(#$DataBaseName#$.dbo.user1.roleName) as number_of_user from #$DataBaseName#$.dbo.rolemodel left join #$DataBaseName#$.dbo.user1 on (#$DataBaseName#$.dbo.rolemodel.roleName=#$DataBaseName#$.dbo.user1.roleName) where #$DataBaseName#$.dbo.rolemodel.roleName=?  group by #$DataBaseName#$.dbo.rolemodel.id,#$DataBaseName#$.dbo.rolemodel.roleName,  #$DataBaseName#$.dbo.rolemodel.description,#$DataBaseName#$.dbo.rolemodel.status,#$DataBaseName#$.dbo.rolemodel.dashboardAccess,#$DataBaseName#$.dbo.rolemodel.lastEdit,#$DataBaseName#$.dbo.rolemodel.createdOn";

	public static final String SELECT_ROLEMODEL = "select  #$DataBaseName#$.dbo.rolemodel.*,count(#$DataBaseName#$.dbo.user1.roleName) as number_of_user from #$DataBaseName#$.dbo.rolemodel left join #$DataBaseName#$.dbo.user1 on (#$DataBaseName#$.dbo.rolemodel.roleName=#$DataBaseName#$.dbo.user1.roleName)  group by #$DataBaseName#$.dbo.rolemodel.id,#$DataBaseName#$.dbo.rolemodel.roleName,  #$DataBaseName#$.dbo.rolemodel.description,#$DataBaseName#$.dbo.rolemodel.status,#$DataBaseName#$.dbo.rolemodel.dashboardAccess,#$DataBaseName#$.dbo.rolemodel.lastEdit,#$DataBaseName#$.dbo.rolemodel.createdOn";
