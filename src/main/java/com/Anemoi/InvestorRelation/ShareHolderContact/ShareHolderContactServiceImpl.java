...
public class ShareHolderContactServiceImpl implements ShareHolderContactService {
	...
	@Override
	public ShareHolderContactEntity createShareHolderContact(ShareHolderContactEntity shareholdercontact) throws ShareHolderContactServiceException {
		try
		{
		...
		//applyValidation(shareholdercontact);
			...
			ShareHolderContactEntity createNewShareHoldercontact=this.shareholdercontactdao.createNewShareHolderContact(shareholdercontact,dataBaseName);
			return createNewShareHoldercontact;
		}
		
		catch(Exception e) {
			e.printStackTrace();
			throw new ShareHolderContactServiceException("unable to create share holder"+e.getMessage());
		}
	...
	private void applyValidation(ShareHolderContactEntity shareholdercontact) throws Exception {
		...
		if(shareholdercontact.getName()==null || shareholdercontact.getName().isEmpty())
		{
		 ...
		 pattern = Pattern.compile("^[A-Z]{1}+[A-Za-z ]*$");
			...
			if(shareholdercontact.getMinorcode()==null || shareholdercontact.getMinorcode().isEmpty())
			{
	...
	@Override
	public ShareHolderContactEntity getShareHolderContactById(String contactid) throws SQLException,ShareHolderContactServiceException {
		try {
			String dataBaseName = ShareHolderContactServiceImpl.dataBaseName();
			if (contactid == null || contactid.isEmpty()) {
			System.out.print("ShareHoldercontact id must not be null or empty");
			}
			ShareHolderContactEntity shareholdercontactEntity = this.shareholdercontactdao.getShareHolderContactById(contactid, dataBaseName);
	...
	@Override
	public List<ShareHolderContactEntity> getAllShareholderContactDetails() throws SQLException,ShareHolderContactServiceException {
		try {
			String dataBaseName = ShareHolderContactServiceImpl.dataBaseName();
			List<ShareHolderContactEntity> shareholdercontactEntity = this.shareholdercontactdao.getAllShareHolderContactDetails(dataBaseName);
	...
	private JSONObject buildJsonFromShareHolderContact(ShareHolderContactEntity shareholdercontact) {
		...
		jsonObject.put(ShareHolderContactQuaryConstant.MINORCODE,shareholdercontact.getMinorcode());
	...
	@SuppressWarnings("unchecked")
	@Override
	public ShareHolderContactEntity updateShareHolderContact(ShareHolderContactEntity shareholdercontact, String contactid) throws ShareHolderContactServiceException {
		try {
			String dataBaseName = ShareHolderContactServiceImpl.dataBaseName();
				if (contactid == null || contactid.isEmpty()) {
				...
				ShareHolderContactEntity shareholder = this.shareholdercontactdao.updateShareHolderContactDetails(shareholdercontact, contactid, dataBaseName);
				JSONObject object = new JSONObject();
	...
	private JSONObject buildJsonFromUpdatedShareHolderContact(ShareHolderContactEntity updatedshareholdercontact) {
		...
		jsonObject.put(ShareHolderContactQuaryConstant.MINORCODE, updatedshareholdercontact.getMinorcode());
	...
	@SuppressWarnings("unchecked")
	@Override
	public ShareHolderContactEntity deleteShareHolderContact(String contactid) throws ShareHolderContactServiceException {
		try {
			String dataBaseName = ShareHolderContactServiceImpl.dataBaseName();
				if (contactid == null || contactid.isEmpty()) {
				...
				ShareHolderContactEntity shareholderdataform =shareholdercontactdao.getShareHolderContactById(contactid, dataBaseName);
