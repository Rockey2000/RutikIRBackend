...
public static final String DATA_BASE_PLACE_HOLDER = "#$DataBaseName#$";
	...
	public static final String CONTACT  = "contact";
	  ...
	  public static final String  INSERT_INTO_SHAREHOLDERCONTACT = "INSERT INTO #$DataBaseName#$.dbo.shareholdercontact values(?,?,?,?,?,?,?)";
		...
		public static final String UPDATE_SHAREHOLDERCONTACT ="UPDATE #$DataBaseName#$.dbo.shareholdercontact SET name=?, poc=?, email=?,minorcode=?,address=?,contact=? WHERE contactid=?";
