...
public class DataIngestionQueryConstant {
	...
	public static final String SELECT_HASHCODE = "SELECT hashCode FROM #$DataBaseName#$.dbo.nonprocessFileTable";

	public static final String SELECT_NPFILEID = "SELECT npFileId FROM #$DataBaseName#$.dbo.nonprocessFileTable WHERE  hashCode=?";
