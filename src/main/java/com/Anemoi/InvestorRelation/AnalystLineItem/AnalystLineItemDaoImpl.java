...
//		System.out.println("analystlineItem" + analystlineItem);
	...
	@Override
	public ArrayList<AnalystLineItemEntity> uploadAnalystLineItem(CompletedFileUpload file, String dataBaseName)
			throws AnalystLineItemDaoException {
		Connection connection = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//						System.out.println(Analystname+ "this analystname not present in analyst details table");
			...
			for (Row row1 : sheet) {
				...
				String analystTableheaderName = (formatter.formatCellValue(row1.getCell(3)).trim());
